### This is a modified version of the script provided with the R library 'CNV-Seq'.
### All rights belong to Xie Chao (http://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-10-80)
